...
namespace vecs {
	...
	using VeEntityTypeDraw = vtll::type_list<VeComponentName, VeComponentPosition, VeComponentOrientation, VeComponentMaterial, VeComponentGeometry>;
	...
	using VeUserTableSizeMap = vtll::type_list<
		...
		, vtll::type_list< VeEntityTypeDraw, vtll::value_list< 15 > >
		, vtll::type_list< VeEntityTypeAnimation, vtll::value_list< 15 > >
		//, ...
	>;
